...
function getChartName() { return $_GET['chartName']; }
function getChartType() { return $_GET['chartType']; }
...
function drawChart() {
    ...
    // for choosing what to show:
    var graphs = {
        balance : [minBalance, maxBalance, avgBalance],
        debit   : [minDebit, maxDebit, avgDebit],
        credit  : [minCredit, maxCredit, avgCredit],
    };
